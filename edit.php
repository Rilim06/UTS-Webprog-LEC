...
<div class="flex justify-center">
    <form class="form" action="update.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="inputs">
            ...
            <div class="sub-input">
                <input class="input" type="text" name="name" value="<?= $row["Food Name"] ?>" />
                <input class="input" type="text" name="category" value="<?= $row["Category"] ?>" />
            </div>
            <div class="sub-input">
                <input class="input" type="text" name="price" value="<?= $row["Price"] ?>" />
                <input class="input" type="text" name="description" value="<?= $row["Description"] ?>" />
            </div>
            <label>Current Picture:<br /><img style="width: 10vw;" src="./Food/<?= $row["Image Path"] ?>"></label>
