...
$sql = "SELECT * FROM foods WHERE Category = 'Side Dish'";
                    ...
                    ?>
                        <div class='flex justify-center gap-4 items-center mt-4'>
                            ...
                            <form method='POST' action='delete_menu.php'>
                                ...
                                <button type='submit' class='bg-[#ee3c20] lalala hover:bg-[#ebe0ce] hover:text-[#ee3c20] font-semibold text-white px-6 py-3 rounded-lg' value='side' name='delete'>Delete</button>
                            </form>
                        </div>
                    <?php
                    } else {
...
<div id="slide-cart">
    ...
    ?>
            ...
            <form action='delete_cart.php' method='POST'>
                <input type='hidden' name='cart-name' value='side'></input>
...
<div id='popup' class="mt-1">
    <form method='POST' action='pesan_process.php' id='cart-form'>
        <input type='hidden' name='id' id='food-id-del' value=''>
        <input type='hidden' name='id' id='food-id' value=''>
        <input type='hidden' value='add_side' name='pesan'>
        <div class="whole">
            <div class="left">
