        ...
        <div class="container">
            ...
            <div class="detail bg-white rounded-lg p-4 shadow-lg text-center w-full">
                ...
                if (!isset($_SESSION["id"]) && !isset($_SESSION["username"])) {
                    ?>
                    <div>
                        <button class='bg-[#ee3c20] text-white px-2 py-1 rounded' onclick='openPopup()'>Choose</button>
                    </div>
                    <?php
                } else {
                    if ($_SESSION["username"] == 'admin') {
                        ...
                        <div class='flex justify-center gap-4 items-center mt-4'>
                            ...
                            <form method='POST' action='delete_menu.php'>
                                ...
                                <button type='submit' class='bg-[#ee3c20] text-white px-2 py-1 rounded' value='main'
