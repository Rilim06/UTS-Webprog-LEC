...
$sql = "SELECT * FROM foods WHERE Category = 'Main Dish'";
        ...
        <div class="container">
            ...
            <div class="detail bg-[#ebe0ce] rounded-lg p-4  shadow-6xl  text-center w-full">
                ...
                <div class="flex md:flex-row flex-col justify-between px-5">
                    <b><h2 id="food-name" class="text-md md:text-2xl xl:text-3xl "></h2></b>
                ...
                ?>
                    <div>
                        <button class='bg-[#ee3c20] lalala hover:bg-[#ebe0ce] hover:text-[#ee3c20] font-semibold text-white px-6 py-3 rounded-lg' onclick='openPopup()'>Choose</button>
                    </div>
                    <?php
                } else {
                    if ($_SESSION["username"] == 'admin') {
                    ?>
                        <div class='flex justify-center gap-4 items-center mt-4'>
                            ...
                            <form method='POST' action='delete_menu.php'>
                                ...
                                <button type='submit' class='bg-[#ee3c20] lalala hover:bg-[#ebe0ce] hover:text-[#ee3c20] font-semibold text-white px-6 py-3 rounded-lg' value='main' name='delete'>Delete</button>
                            </form>
                        </div>
                    <?php
                    } else {
                    ?>
                        <div>
                            <button class='bg-[#ee3c20] mr-3 lalala hover:bg-[#ebe0ce] hover:text-[#ee3c20] font-semibold text-white px-6 py-3 rounded-lg' onclick='openPopup()'>Choose</button>
                        </div>
                <?php
                    }
                }
...
<div id='popup' class="mt-1">
    <form method='POST' action='pesan_process.php' id='cart-form'>
        <input type='hidden' name='id' id='food-id-del' value=''>
        <input type='hidden' name='id' id='food-id' value=''>
        <input type='hidden' value='add_main' name='pesan'>
        <div class="whole">
            <div class="left">
